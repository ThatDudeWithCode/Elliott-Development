    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-userAppointments">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($appointments as $key => $appointment)
                            <tr data-entry-id="{{ $appointment->id }}">
                                ...
                                <td>
                                    @foreach($appointment->users as $key => $item)
...
@endcan
  ...
  $('.datatable-userAppointments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
